...
class HybridKVCacheCoordinator(KVCacheCoordinator):
    ...
    def __init__(
        ...
        # block instead -- that relaxation is vllm#50493, carried here, and it is
        # why the dcp_world_size == 1 gate upstream applies is dropped.
        ...
        # vllm#51843: a group whose manager needs block-aligned lookups cannot
        # serve a fine-grained hit. Kept as upstream wrote it -- under DCP this
        # is the guard that stands in for the gate removed above.
